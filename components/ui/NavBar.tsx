  ...
  return (
    <nav className="py-5 flex justify-between items-center">
      <div className="flex gap-x-2 items-center">
        ...
        <h5 className="text-2xl font-black dark:text-gray-300 text-orange-400">crumbs.</h5>
      </div>
      <div className="flex items-center gap-x-2">
        <div className="w-8 h-8 bg-gray-600 dark:bg-gray-200 rounded-full"></div>
        <h6 className="font-normal text-gray-700 dark:text-gray-200">Eldar Dautović</h6>
        <div
